...
//    private String englishText = "",hindiText = "", koreanText = "", chineseText = "", japaneseText = "";
...
//        speechrate = MainActivity.speech_rate;
...
//        Log.d("Inside detection",""+textrecog);
...
//                Log.d("Checking OCR", ""+result.getText());
...
//                                                    Toast.makeText(TextSpeech.this,alltext.toString(),Toast.LENGTH_SHORT).show();
//                                                    alltext.append(" ..");
...
//
                                ...
                                runOnUiThread(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        Log.d("Checking indexes", ""+(index+1) + " "+textView.getText().toString().length());
                                        if(index == textView.getText().toString().length()){
                                            btnPausePlay.performClick();
                                            isLast = true;
